...
export function InFigure({children}:{children?:ReactNode}){
    ...
    return <div  className="position-r w-100 d-bloc ">
        <div  style={setStyleResponsive({height:defaultHeight*3},{height:window.innerHeight*6},null,responsiveSize)} className="d-flex jC-center fd-column">
            <div className={"w-100 h-100 m-0 " + bgColor} id="InFigure">
                ...
                >
                    <div className={setClassResponsive(" ","h-15 w-70","h-25 w-90",null,responsiveSize)}>
                        {firstInFigure}
                    </div>
                    <div className={setClassResponsive("d-flex jC-center alC-center","h-25","h-5 w-90",null,responsiveSize)}>
                        <img src="/PF.png" className="h-100 border-bronze-12 br-2"></img>
                    </div>
                    <div className={setClassResponsive("h-5 ","w-70","w-90",null,responsiveSize)}>
                        {segondInFigure}
                    </div>
