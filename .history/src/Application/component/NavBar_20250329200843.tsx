        ...
        <div>
            <div className={setClassResponsive(
                        ...
                        <ResponsiveBigger height={null} width={responsiveSize}>
                            <div className='d-flex jC-between  h-100 w-50 alC-center al-center'>
...
function DropDownList({buttons}:DropDownListInterface){
    ...
    return (
        <motion.div 
            className='position-a bg-gray left-50 h-400px w-50 bg-purple-8  d-flex fd-column jC-evenly z-100'
            style={{ top: "100px" }}
            initial={{y:"-100%"}}
            animate={{y:"0%"}}
        >
