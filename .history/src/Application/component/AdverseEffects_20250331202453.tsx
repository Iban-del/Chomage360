...
export function AdverseEffects({children}:{children?:ReactNode}){
    ...
    return <div  className="position-r top-10 w-100 d-bloc ">
        <div style={setStyleResponsive({height:defaultHeight*3},{height:defaultHeight*7},null,responsiveSize)} className="d-flex jC-center fd-column">
            ...
            <div className={"w-100 h-100 m-0 "+bgColor} id="AdverseEffects">
                ...
                >
                    ...
                    <div className={setClassResponsive("","h-20 w-70","h-30 w-90",null,responsiveSize)}>
                        {secondAdverseEffect}
                    </div>
                    <div className={setClassResponsive("d-flex jC-center","h-20","h-20 w-90",null,responsiveSize)}>
                    <img src="/soldeFp.png" className="w-50 border-bronze-12 br-2"></img>
                    </div>
                    <div className={setClassResponsive("","h-20 w-70","h-10 w-90",null,responsiveSize)}>
                        {thirdAdverseEffect}
                    </div>
                </div>
            </div>
