        ...
        <div  style={setStyleResponsive({height:defaultHeight*1.5},{height:window.innerHeight*4},null,responsiveSize)} className="d-flex jC-center fd-column">
            <div className={"w-100 h-100 m-0 " + bgColor} id="InFigure">
                ...
                >
                    ...
                    <div className={setClassResponsive("d-flex jC-center alC-center","h-50","h-15 w-90",null,responsiveSize)}>
                        <img src="/PF.png" className="h-100 border-bronze-12 br-2"></img>
                    </div>
                    <div className={setClassResponsive("alC-center","h-20 w-70","h-35 w-90",null,responsiveSize)}>
                        {segondInFigure}
                    </div>
