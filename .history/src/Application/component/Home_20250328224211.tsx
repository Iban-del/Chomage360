...
export function Home({children}:{children?:ReactNode}){
    ...
    return <div style={{top:"100px"}}  className="position-r  w-100 h-100 d-bloc ">
        ...
        <div style={{height:window.innerHeight*4}} className="d-flex jC-center" id="Home">
            <div
                className={setClassResponsive("text-decoration-line-through-1 h-100 d-flex jC-center al-center fd-column","w-50","w-90",null,responsiveSize)}>
                <p>
                    {HomeContent}
                </p>
            </div>
