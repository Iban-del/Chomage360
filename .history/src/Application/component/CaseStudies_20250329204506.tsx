...
export function CaseStudies({children}:{children?:ReactNode}){
    const bgColor = "bg-purple-a7";

    return <div  className="position-r top-10 w-100 d-bloc " id="CaseStudies">
        <div style={setStyleResponsive({height:defaultHeight},{height:window.innerHeight*3},null,responsiveSize)} className={"d-flex jC-center fd-column "+ bgColor} >
            <div
