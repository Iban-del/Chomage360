...
export function PositiveEffect({children}:{children?:ReactNode}){
    ...
    return <div   className="position-r top-10 w-100  d-bloc ">
        <div style={setStyleResponsive({height:defaultHeight*3},{height:defaultHeight*5},null,responsiveSize)} className={"h-100 d-flex jC-center fd-column "+bgColor} id="PositiveEffect">
            <div
            ...
            >
                <div className={setClassResponsive("p-2  ","w-70 h-40","w-100",null,responsiveSize)}>
                    {firstPositiveEffect}
                </div>
                <div className={setClassResponsive("w-100","h-20","",null,responsiveSize)}>
                    <img src=""></img>
                </div>
                <div className={setClassResponsive("p-2 ","h-40 w-70","w-100",null,responsiveSize)}>
