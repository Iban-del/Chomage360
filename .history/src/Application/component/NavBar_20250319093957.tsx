    ...
    return (
        <div>
            <div className={setClassResponsive(
                                    "h-100px w-100  d-flex al-center position-f z-99","bg-blue-a1","bg-gray",
                                    null,
                                    responsiveSize
            )}>
                        <ResponsiveBigger height={null} width={850}>
                            <div className='d-flex jC-between p-2 h-100 w-50 alC-center'>
                                <h1 className='font-size-a6 '>Iban <br/> DELETOILLE-ELIZALDE</h1>
                            </div>
                        ...
                        <ResponsiveSmaller height={null} width={850}>
                            <div className='d-flex jC-start p-2 h-100 w-80 alC-center'>
                                <h6 className='font-size-a4 '>Iban <br/> DELETOILLE-ELIZALDE</h6>
                            </div>
