        ...
        <div style={setStyleResponsive({height:defaultHeight*5},{height:defaultHeight*7},null,responsiveSize)} className="d-flex jC-center fd-column">
            ...
            <div className={"w-100 h-100 m-0 "+bgColor} id="AdverseEffects">
                ...
                >
                    ...
                    <div className={setClassResponsive("h-20 w-100 d-flex jC-center","","w-90",null,responsiveSize)}>
                        <img src="/depencePourEmploi.png" className="w-50 border-bronze-12 br-2"></img>
                    </div>
                    <div className={setClassResponsive("h-30"," w-70","w-90",null,responsiveSize)}>
                        {secondAdverseEffect}
                    </div>
                    <div className={setClassResponsive("h-20 w-100 d-flex jC-center","","w-90",null,responsiveSize)}>
                    <img src="/soldeFp.png" className="h-100 border-bronze-12 br-2"></img>
                    </div>
                    <div className={setClassResponsive("h-10"," w-70","w-90",null,responsiveSize)}>
                        {thirdAdverseEffect}
                    </div>
                </div>
            </div>
