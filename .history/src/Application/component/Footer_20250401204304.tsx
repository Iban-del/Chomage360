...
const sources: Array<sourceInterface> = [
    ...
    },
    {
        ...
        url: "https://www.lemonde.fr/economie/article/2024/10/12/en-espagne-et-au-portugal-le-defi-de-faire-adopter-le-budget-par-un-parlement-fragmente_6349758_3234.html"
    },
    {
        ...
        <footer className="bg-gray-900 text-white py-10 mt-10">
            <div className="max-w-7xl mx-auto px-5">
                ...
                <div className="border-t border-gray-700 mt-10 pt-5 text-center text-sm">
                    <p>&copy; {new Date().getFullYear()} Elouane DELETOILLE-ELIZALDE - Flora VIANNAIS</p><br></br>
                    <p>Développeur/Designer Iban DELETOILLE-ELIZALDE</p>
                </div>
            </div>
            {children}
        </footer>
