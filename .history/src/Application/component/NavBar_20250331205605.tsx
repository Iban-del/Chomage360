    ...
    return (
        <div>
            <div className={setClassResponsive(
                                    "h-100px w-100 d-flex al-center position-f text-white z-99 bg-gray-900 m-0","","",
                                    null,
                                    responsiveSize
            )}>
                        <ResponsiveBigger height={null} width={responsiveSize}>
                            <div className='d-flex jC-strat  h-100 w-30 alC-center al-center'>
                                <img src='/icon.jpg' className='h-100'/>
                                {/* <h1 className='font-size-a6 m-2 '>Chômage 360</h1> */}
                            </div>
                            <div className='p-2 d-flex jC-end h-100 w-70 al-end alC-center al-center '>
                                {buttons}
                            </div>
                        </ResponsiveBigger>
...
function DropDownList({buttons}:DropDownListInterface){
    ...
    return (
        <motion.div 
            className='position-a left-50 h-400px w-50 bg-gray-900 d-flex text-white fd-column jC-evenly z-100'
            style={{ top: "100px" }}
            initial={{y:"-100%"}}
            animate={{y:"0%"}}
        >
