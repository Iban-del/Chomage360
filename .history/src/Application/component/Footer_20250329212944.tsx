    ...
    return <div   className="position-r w-100 d-bloc ">
        <div style={{height:window.innerHeight*.5}} className={"h-100 d-flex jC-center fd-column "+bgColor} id="PositiveEffect">
            <div className={setClassResponsive("","","",null,responsiveSize)}>
                ...
                <a href="https://www.capital.fr/economie-politique/sortie-de-crise-comment-l-espagne-nous-fait-la-lecon-1036642">https://www.capital.fr/economie-politique/sortie-de-crise-comment-l-espagne-nous-fait-la-lecon-1036642.</a>
                </p>
            </div>
        </div>
        {children}
