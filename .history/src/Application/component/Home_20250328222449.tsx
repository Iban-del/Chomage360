...
export function Home({children}:{children?:ReactNode}){
    ...
    return <div style={{top:"100px"}}  className="position-r  w-100 h-100 d-bloc ">
        <div style={{height:window.innerHeight*2}} className="d-flex jC-center fd-column al-center " id="Home">
            <div
                className={setClassResponsive("h-50 d-flex jC-center al-center fd-column","w-50","w-90",null,responsiveSize)}>
