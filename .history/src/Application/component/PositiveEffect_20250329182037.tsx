...
export function PositiveEffect({children}:{children?:ReactNode}){
    ...
    return <div   className="position-r top-10 w-100  d-bloc ">
        <div style={setStyleResponsive({height:window.innerHeight*2},{height:window.innerHeight*4},null,responsiveSize)} className={"h-100 d-flex jC-center fd-column "+bgColor} id="PositiveEffect">
            <div
