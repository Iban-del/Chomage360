...
export function PositiveEffect({children}:{children?:ReactNode}){
    ...
    return <div   className="position-r top-10 w-100  d-bloc ">
        <div style={setStyleResponsive({height:defaultHeight*3},{height:window.innerHeight*8},null,responsiveSize)} className={"h-100 d-flex jC-center fd-column "+bgColor} id="PositiveEffect">
            <div
